...
ent4 = Entry(window,bd=3, bg="purple", justify="center")
ent4.grid(row=1, column = 0)
ent4.insert(0,"row 1, column 0")

ent5 = Entry(window,bd=3, bg="purple", justify="center")
ent5.grid(row=1, column = 1)
ent5.insert(0,"row 1, column 1")

ent6 = Entry(window,bd=3, bg="purple", justify="center")
ent6.grid(row=1, column = 2)
ent6.insert(0,"row 1, column 2")

ent7 = Entry(window,bd=3, bg="red", justify="center")
ent7.grid(row=2, column = 0)
ent7.insert(0,"row 2, column 0")

ent8 = Entry(window,bd=3, bg="red", justify="center")
ent8.grid(row=2, column = 1)
ent8.insert(0,"row 2, column 1")

ent9 = Entry(window,bd=3, bg="red", justify="center")
